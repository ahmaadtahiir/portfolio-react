        ...
        <div name="home" className="w-full h-screen bg-gray-200">
            <div className="max-w-screen-lg h-full mx-auto flex flex-col justify-center items-center px-4 md:flex-row">
                ...
                <div className="h-full w-full flex flex-col justify-center sm:w-1/2">
                    ...
                    <span className="flex justify-start text-gray-500 font-Economica text-lg pt-2 sm:text-xl sm:pt-4">I brings a holistic perspective to every project, seamlessly integrating frontend and backend elements into a cohesive whole.</span>
