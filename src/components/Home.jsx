...
const Home = () => {
    return (
    // <div className="grid grid-cols-2 md:grid-cols-2 gap-4 bg-gray-200 px-40" id="home">
    //     < div className="items-center justify-center mt-40" >
    //         <span className="flex text-gray-700 text-5xl font-Advent font-bold ml-32">Ahmad Tahir</span>
    //         <span className="flex text-gray-700 font-Economica text-3xl ml-32 pt-4"> Software Engineer</span>
    //         <span className="flex text-gray-500 font-Economica text-xl ml-32 pr-16 pt-4">I brings a holistic perspective to every project, seamlessly integrating frontend and backend elements into a cohesive whole.</span>
    //         <button type="button" className="flex px-10 py-3 ml-32 mt-12 text-xl font-Economica text-center text-white font-family:cursive bg-gray-700 rounded-lg hover:bg-gray-900">Say Hello  &nbsp;
    ...
    //             </svg>
    //         </button>
    //         <div className="flex items-center ml-32 pt-20">
    //             <svg fill="currentColor" className="w-7 h-7" strokeWidth=".5" stroke="currentColor" viewBox="0 0 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    //             </svg>
    //             <span className="flex text-gray-500 font-Economica text-xl">Scroll down&nbsp;</span>
    ...
    //         <img className="rounded-full w-full transition-all duration-900 hover:grayscale" src={ahmad1} alt="" onClick={sayHello()} />
    //         {/* <img className="w-80 h-80 border-gray-700 transition-all duration-900 hover:grayscale" src={profilepic} alt="" onClick={sayHello()} /> */}
    //         {/* <img className="w-80 h-80 border-gray-700 transition-all duration-900 hover:grayscale" src={profilepic} alt="" onClick={sayHello()} /> */}
        ...
        <div name="home" className="w-full h-screen bg-gray-200">
            <div className="max-w-screen-lg h-full mx-auto flex flex-col justify-center items-center px-4 md:flex-row">
                ...
                <div className="h-full w-full flex flex-col justify-center sm:w-1/2">
                    ...
                    <span className="flex text-gray-500 font-Economica text-lg pt-2 sm:text-xl sm:pt-4">I brings a holistic perspective to every project, seamlessly integrating frontend and backend elements into a cohesive whole.</span>
                    {/* <a href="mailto:ahmaadtahiir@gmail.com"> */}
                    <button type="button" className="w-fit flex px-5 py-2 mt-6 text-md font-Economica text-center text-white font-family:cursive bg-gray-700 rounded-lg hover:bg-gray-900 sm:px-10 sm:mt-12 sm:text-xl">Say Hello  &nbsp;
